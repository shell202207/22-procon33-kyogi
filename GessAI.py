# -*- coding: utf-8 -*-
"""
Created on Thu Oct  6 10:37:26 2022
...
def get_path_labels(self):
	...
	dirs_path = glob.glob("C:\\Users\ore\Documents\KerasMake\sample")
...
if __name__ == '__main__':
	...
	# ジェネレータを作成
	train_batch_generator = WaveMaker.BatchGenerator(X_train, y_train, batch_size, sample_rate, sample_length, threshold)
	test_batch_generator = WaveMaker.BatchGenerator(X_val, y_val, batch_size, sample_rate, sample_length, threshold)
